...
class PCGClassifier_Single(pl.LightningModule):
    def __init__(self, mu=0.5, epsilon=0.5):
        super().__init__()
        #CHANGE FOR SINGLE  
        ...
        self.murmur_clf = nn.Linear(256*49, 3) #MAGIC NUMBER change the 49
        self.outcome_clf = nn.Linear(256*49,2)
